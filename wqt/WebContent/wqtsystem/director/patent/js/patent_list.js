...
function doSubmitForm()
{
	...
	var url='sysPatent_selectPatentShopLists.action';
	
	url+='?iprPatentShop.patentname='+patentname
		 +'&iprPatentShop.displayname='+displayname
...
function formatname(val,row,index){
	 return '<a href="http://ipr.w7tong.com/'+row.htmlpath+'" target="_blank"  title="'+row.patentname+'" style="margin-left:5px;">'+row.patentname+'</a>'; 
}
