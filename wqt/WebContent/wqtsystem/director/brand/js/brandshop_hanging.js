...
function formatkind(val,row,index){
	var text='';
		text=row.brandkind.substring(0,2);
    return text;
}

function formatbrandname(val,row,index){
	 return '<a href="http://ipr.w7tong.com/'+row.htmlpath+'" target="_blank"  title="'+row.brandname+'" style="margin-left:5px;">'+row.brandname+'</a>'; 
}
