...
function doSubmitForm()
{
	...
	var url='sysBrandProduct_selBrandProductList.action';
	
	url+='?iprBrandProduct.productname='+productname
		 +'&iprBrandProduct.kindid='+kindid
	     +'&iprBrandProduct.state='+state
...
function  perfectProduct(patentid)
{
	layer.open({
		    ...
		    shade : 0.8,
		    area : [ '700px', '275px' ],
		    content : 'brandProduct_update.html?id='+patentid // iframe的url
		});
}
