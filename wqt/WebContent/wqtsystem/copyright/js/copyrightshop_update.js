...
$(function(){	
	$('#copyrightForm').form('load', 'sysCopyright_selectCopyrightShopOne.action?iprCopyrightShop.id='+id);
	$("#copyrightForm").form({ 
		 onLoadSuccess: function () { 
			   ...
			   $("#viewimg").attr('src',localhostPaht+"/"+$('#copyrightphoto').val()); 
			// document.getElementById("filepath").innerHTML=$('#newicon').val();
		 } 
	});
	$.ajax({
		url:"sysCopyright_selIprCopyrightShopPhotoOne.action?iprCopyrightShop.id"+id,
		type:"get",
		data:{
...
function dodelete(id){
	...
	if(m==true){
		$.ajax({
			type:"get",
			url:"sysCopyright_delIprCopyrightShopPhoto.action",	
			dataType:"json",
			data:{
