...
function onBeforeReady() {
	this.setOptions({
		initSource : 'org_initFirstGradeOrgTree.action?moduleId=M44&modeId=view&roleID=' + roleID,
		asyncDataSource : 'org_initGradeOrgTree.action?moduleId=M44&modeId=view&roleID=' + roleID
	});
}
