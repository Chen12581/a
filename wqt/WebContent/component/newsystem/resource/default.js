...
function operRenderer() {
	var data = fastDev.getInstance("permissionDatagrid").getValue(this)[0];
	var width = fastDev(this).width();
	if (data.modeId == 'transfer' || data.modeId == 'grant' || data.modeId == 'view')
	{
...
function batchDeletePermission(){
    ...
    {
        var obj = list[i];
        if (obj.modeId == 'transfer' || obj.modeId == 'grant' || obj.modeId == 'view')
        {
        	fastDev.alert("不能移除资源与访问方式“委托”、“授权”、“查看”的关联。","信息提示","warning");
        	return;
        }
