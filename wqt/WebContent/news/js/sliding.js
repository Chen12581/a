(function($) {
    $.fn.SliderImgPuzzle = function(setting) {
        ...
        function getRandomImg() {
            return (
                "/image/slider_img/" +
                getRandomNumberByRange(0, 30)+".jpg"
            );
        }
        function draw(ctx, operation, x, y, type) {
            if (type == 1) draw1(ctx, operation, x, y);
            else if (type == 2) draw2(ctx, operation, x, y);
            else if (type == 3) draw3(ctx, operation, x, y);
            else if (type == 4) draw4(ctx, operation, x, y);
            else if (type == 5) draw5(ctx, operation, x, y);
            else if (type == 6) draw6(ctx, operation, x, y);
        }
        ...
        class sliderImgPuzzle {
            ...
            bindEvents() {
                ...
                this.sliderImgPuzzle.addEventListener("mousedown", function(e) {
                    if (
                        !this.parentElement.parentElement.classList.contains(
                            "sliderImgPuzzleContainer_success"
                        )
                    ) {
                ...
                this.canvasContainer.parentElement.addEventListener(
                    "mouseleave",
                    function(e) {
                ...
                addClass(
                    ...
                    "sliderImgPuzzleContainer_active"
                );
