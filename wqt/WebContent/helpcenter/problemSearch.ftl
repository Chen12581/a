...
<head>
    ...
    <title>常见问题-${problemKindData.searchkey?if_exists}</title>
    <script>
        //百度推送
        (function(){
            ...
            <div class="help-problems">
                ...
                <div class="help-problems-r">
                    <div class="help-problems-ra">
                        ...
                        <span>></span>
                        <i>
                           ${problemKindData.searchkey?if_exists}
                        </i>
                    </div>
		                    ...
		                    <div class="help-problems-rc">
		                        <div class="help-problems-rc-pub">
		                            <div class="help-problems-rca">
		                                <div class="help-problems-rcal"><a href="/${wqtProblem.htmlpath?if_exists}">${wqtProblem.title?if_exists}</a></div>
                    ...
                    <#else>
                      <div class="help-problems-rc">
		                        <div class="help-problems-rc-pub">
		                            <div class="help-problems-rca">
		                                    很抱歉，我们暂时无"${problemKindData.searchkey?if_exists} "的相关内容
		                             </div>
		                        </div>
		                    </div>
                    ...
                    <div class="list_bottom">
                        <div class="list_pages clear">
                            <span class="backhome fl">
                                <a href="/problem/search/${problemKindData.searchkey?if_exists}/${problemKindData.pagenum?if_exists}.html">首页</a>
                            </span>
                            <span class="prevpage fl">
                              <#if problemKindData.pagenum?number gt 1>
		                         <a href="/problem/search/${problemKindData.searchkey?if_exists}/${problemKindData.pagenum?number-1}.html" id="prevA0">上一页</a>
		                      <#else>
                            ...
                            <span class="nextpage fl">
                                 <#if problemKindData.pagenum?number lt problemKindData.problempage?number>
			                         <a href="/problem/search/${problemKindData.searchkey?if_exists}/${problemKindData.pagenum?number+1}.html" id="nextA0">下一页</a>
			                      <#else>
			                         <a href="javascript:;" id="nextA0">下一页</a>
			                      </#if>
                            </span>
                            <span class="lastpage fl">
                                <a href="/problem/search/${problemKindData.searchkey?if_exists}/${problemKindData.problempage?if_exists}.html">尾页</a>
                            </span>
                            <span class="total f1">
