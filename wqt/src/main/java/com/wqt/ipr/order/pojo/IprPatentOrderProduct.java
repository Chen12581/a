...
/*专利订单详情*/
public class IprPatentOrderProduct {
	private String id;               // 
    private String patentproductname; //专利产品名称
    private String patentproductdesc; //专利产品简介
    private String patenticon;        //专利图标
	...
	public String getPatentproductname() {
		return patentproductname;
	}
	public void setPatentproductname(String patentproductname) {
		this.patentproductname = patentproductname;
	}
	public String getPatentproductdesc() {
		return patentproductdesc;
	}
	public void setPatentproductdesc(String patentproductdesc) {
		this.patentproductdesc = patentproductdesc;
	}
