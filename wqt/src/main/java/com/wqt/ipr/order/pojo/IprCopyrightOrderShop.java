...
/*版权交易订单*/
public class IprCopyrightOrderShop {
	private String id;                    //
    ...
    private String copyrightkind;         //版权分类
    private String copyrightstate;        //版权商品的状态
    private String copyrightkindname;     //版权分类名称
    private String copyrightcode;         //版权编号
    private String competentmethod;       //授权方式 1：独家2：非独家
	...
	public void setCopyrightstate(String copyrightstate) {
