...
/*版权订单详情*/
public class IprCopyrightOrderProduct {
	    private String id;               // 
	    private String copyrightproductname; //版权产品名称
	    private String copyrightproductdesc; //版权产品简介
	    private String copyrighticon;    //版权图标
		...
		public String getCopyrightproductname() {
			return copyrightproductname;
		}
		public void setCopyrightproductname(String copyrightproductname) {
			this.copyrightproductname = copyrightproductname;
		}
		public String getCopyrightproductdesc() {
			return copyrightproductdesc;
		}
		public void setCopyrightproductdesc(String copyrightproductdesc) {
			this.copyrightproductdesc = copyrightproductdesc;
		}
